...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"4f0bbded-9898-45c6-8f94-a60b60197369\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [37 x i8] c"com.companyname.rbicbdchackathon2023\00", align 16
...
@__DSOCacheEntry_name.16 = internal constant [49 x i8] c"libaot-Xamarin.Google.Crypto.Tink.Android.dll.so\00", align 16
...
@__DSOCacheEntry_name.23 = internal constant [35 x i8] c"libaot-RbiCbdcHackathon2023.dll.so\00", align 16
...
@__DSOCacheEntry_name.27 = internal constant [48 x i8] c"libaot-System.ComponentModel.Annotations.dll.so\00", align 16
...
@__DSOCacheEntry_name.40 = internal constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
@__DSOCacheEntry_name.41 = internal constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
@__DSOCacheEntry_name.42 = internal constant [36 x i8] c"libaot-Microsoft.Data.Sqlite.dll.so\00", align 16
...
@__DSOCacheEntry_name.46 = internal constant [50 x i8] c"libaot-Microsoft.Extensions.Caching.Memory.dll.so\00", align 16
...
@__DSOCacheEntry_name.57 = internal constant [55 x i8] c"libaot-Xamarin.AndroidX.Security.SecurityCrypto.dll.so\00", align 16
...
@__DSOCacheEntry_name.83 = internal constant [16 x i8] c"libe_sqlite3.so\00", align 16
...
@__DSOCacheEntry_name.90 = internal constant [51 x i8] c"libaot-Microsoft.EntityFrameworkCore.Sqlite.dll.so\00", align 16
@__DSOCacheEntry_name.91 = internal constant [41 x i8] c"libaot-System.Diagnostics.Tracing.dll.so\00", align 16
...
@__DSOCacheEntry_name.99 = internal constant [51 x i8] c"libaot-Microsoft.Extensions.DependencyModel.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [690 x %struct.DSOCacheEntry] [
	...
	; 23
	%struct.DSOCacheEntry {
		i64 730694942279798599, ; hash 0xa23f32db9c30f47, from name: libaot-RbiCbdcHackathon2023.dll.so
		i8 0, ; ignore
	...
	; 117
	%struct.DSOCacheEntry {
		i64 3199107271058656406, ; hash 0x2c65831d09d20c96, from name: RbiCbdcHackathon2023
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 343
	%struct.DSOCacheEntry {
		i64 9183488665288149555, ; hash 0x7f724e48ed538a33, from name: aot-RbiCbdcHackathon2023
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 474
	%struct.DSOCacheEntry {
		i64 12370010774690884451, ; hash 0xabab1b42ad346b63, from name: RbiCbdcHackathon2023.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 479
	%struct.DSOCacheEntry {
		i64 12541379676065797779, ; hash 0xae0bee5e49349693, from name: aot-RbiCbdcHackathon2023.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 630
	%struct.DSOCacheEntry {
		i64 16742244542179488087, ; hash 0xe85866b4f754b157, from name: libaot-RbiCbdcHackathon2023
		i8 0, ; ignore
		i8* getelementptr inbounds ([35 x i8], [35 x i8]* @__DSOCacheEntry_name.23, i32 0, i32 0), ; name
		i8* null; handle
	}, 
